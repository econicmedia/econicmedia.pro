...
const ImageViewer = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80" onClick={onClose}>
      <div
        className="bg-gray-900/95 border border-gray-800 rounded-xl shadow-xl max-w-5xl w-full p-4 relative overflow-hidden"
      ...
      >
        ...
        <div className="relative flex justify-center items-center" style={{ maxHeight: 'calc(100vh - 10rem)' }}>
          <motion.img
            key={image.id}
            src={image.src}
            alt=""
        ...
        <div className="max-w-3xl mx-auto mb-10">
          ...
          <ScrollReveal delay={250}>
            <p className="text-center text-foreground/70 mb-12 max-w-prose mx-auto leading-relaxed tracking-wider text-base">
              Our passion lies in transforming ordinary products and websites into captivating visual stories that resonate with your audience. Each image in this gallery is a testament to our commitment to detail, design, and composition, designed to make your brand stand out and drive engagement.
            </p>
          </ScrollReveal>
        </div>
