      ...
      <div className="container max-w-7xl mx-auto py-12 px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            >
              ...
              <span className="font-medium">wtf@econicmedia.pro</span>
            </a>
          </div>
          ...
          <div>
            ...
            <nav className="space-y-2">
              <a 
                href="#home" 
                className="text-sm text-foreground/70 hover:text-foreground transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-gradient-neon after:scale-x-0 after:origin-right after:transition-transform hover:after:scale-x-100 hover:after:origin-left block"
              >
                Home
              </a>
              <a 
        ...
        <div className="border-t border-white/10 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-4">
            <a href="#" className="text-foreground/70 hover:text-neon-cyan transition-colors">
