...
const portfolioItemsData: PortfolioItemType[] = [
  // New website showcase items
  { id: 'ablass-reinigung', title: 'Ablass Reinigung GmbH', category: 'Cleaning Services Website', imageUrl: '/Websites/ablass.png', liveUrl: 'https://rein-glanz-service-gmbh.lovable.app/', description: 'Professional cleaning service website with modern design, showcasing commercial and residential cleaning services with easy booking and transparent pricing.' },
  { id: 'benfresh', title: 'Benfresh.de', category: 'E-commerce Website', imageUrl: '/Websites/Benfresh.de.png', liveUrl: 'https://benfresh.de', description: 'E-commerce platform with clean, user-friendly interface offering a seamless shopping experience with optimized product displays and secure checkout process.' },
  { id: 'callsaver', title: 'Callsaver.app', category: 'SaaS Application', imageUrl: '/Websites/Callsaver.app.png', liveUrl: 'https://callsaver.app', description: 'SaaS application with intuitive user experience and modern UI designed to help businesses manage and optimize their call handling processes efficiently.' },
